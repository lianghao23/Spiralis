...
export const siteConfig: SiteConfig = {
	title: "Spiralis",
	subtitle: "生活如同循环，但并非原地运转",
	siteURL: "https://spiralis.vercel.app/", // 请替换为你的站点URL，以斜杠结尾
	...
	// navbarTitle: {
	// 	// 顶栏标题文本
	// 	text: "Lianghao's Blog",
	// 	// 顶栏标题图标路径，默认使用 public/assets/home/home.png
	// 	icon: "assets/home/favicon-dark-192.png",
	// },
	...
	banner: {
		...
		homeText: {
			...
			title: "Spiralis · 螺旋", // 主页横幅主标题

			subtitle: [
				"阳光好的时候，就把自己放进去，像放一块陈皮",  
				"进一寸有进一寸的欢喜",
				"每个人都在时间里孤独地旋转", 
				"我与我周旋久，宁作我",
				"慢慢来，比较快",
	...
	favicon: [
		// 留空以使用默认 favicon
		{
        src: '/favicon/favicon-light-180.png',    // 你的图标路径（放在 public 目录下）
        theme: 'light',                  // 亮色模式图标
        sizes: '32x32',
		},
		{
			src: '/favicon/favicon-dark-180.png', // 暗色模式图标
			theme: 'dark',
			sizes: '32x32',
    	}
	],
	...
	links: [
		...
		// 支持自定义导航栏链接,并且支持多级菜单,3.1版本新加
		{
			...
			children: [
				{
					name: "GitHub",
					url: "https://github.com/lianghao23",
					external: true,
					icon: "fa6-brands:github",
				},
				{
					name: "Bilibili",
					url: "https://space.bilibili.com/646321310",
					external: true,
					icon: "fa6-brands:bilibili",
				},
				{
					name: "Gitee",
					url: "https://gitee.com/liang-hao23",
					external: true,
					icon: "mdi:git",
				},
			],
